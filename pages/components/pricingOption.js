...
import classNames from "classnames"; // For cleaner class name handling
  ...
  return (
    <div
      className={classNames(
        "rounded-lg shadow-md p-4", // Base styles
        "hover:shadow-lg hover:bg-gray-100", // Hover effects
        isActive ? "bg-gray-200" : "" // Active state background
      )}
      // onClick={handleClick}
    >
